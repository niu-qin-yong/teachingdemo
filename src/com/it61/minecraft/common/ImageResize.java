...
public class ImageResize {
	...
	private static int WIDTH = 50; // 缩略图宽度
	private static int HEIGHT = 50;// 缩略图高度
	...
	public static BufferedImage resize(byte[] imageData){
		ImageIcon imgIcon = new ImageIcon(imageData);
		Image img = imgIcon.getImage();
		return resize(img);
	}
	public static BufferedImage resize(String srcFileName) {
	...
	public static BufferedImage resize(Image srcImage) {
